package com.yspay
{
    ...
    public class YsVarArray extends YsVar
    {
        ...
        public function Remove(ys_var:*):void
        {
            for (var idx:int = 0; idx < var_value.length; ++idx)
            {
                if (var_value[idx] == ys_var)
                    var_value.splice(idx, 1);
            }
        }
        ...
        public override function Pack():ByteArray
        {
            ...
            var_len_of_all = 4 /*length of itself*/ + 2 /*length of len_of_key*/ + var_key.length + 4 /*length of max*/ + 4 /*length of size*/;
